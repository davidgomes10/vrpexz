function drawTxt(x,y ,width,height,scale, text, r,g,b,a)
    ...
    DrawText(x - width/2.93, y - height/3.3 + 0.005)
end
			...
			for i = 0,32 do
				if(GetPlayerName(i))then
					if(NetworkIsPlayerTalking(i))then
						...
						if(t == 1)then
								drawTxt(0.800, 0.300, 1.0,1.0,0.4, "~y~Talking", 255, 255, 255, 255)
						end

						drawTxt(0.850, 0.300, 1.0,1.0,0.4, "" .. GetPlayerName(i), 255, 255, 255, 255)
					end
				end
			end
	end
