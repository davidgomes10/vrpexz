		...
		if(IsPedInAnyVehicle(MyPed, false))then
			...
			if HUD.Top then
				...
				if HUD.ParkIndicator then
					...
					if VehStopped then
						--drawTxt(UI.x + 0.6605, UI.y + 1.262, 1.0,1.0,0.6, "~r~V", 255, 255, 255, 200)
					else
						--drawTxt(UI.x + 0.6605, UI.y + 1.262, 1.0,1.0,0.6, "V", 255, 255, 255, 150)
					end
				end
			else
				if HUD.Plate then
				...
				if HUD.ParkIndicator then
					...
					if VehStopped then
						--drawTxt(UI.x + 0.643, UI.y + 1.34, 1.0,1.0,0.6, "~r~V", 255, 255, 255, 200)
					else
						--drawTxt(UI.x + 0.643, UI.y + 1.34, 1.0,1.0,0.6, "V", 255, 255, 255, 150)
					end
				end
			end
			...
			if HUD.Speed == 'kmh' then
                    drawTxt(UI.x + 0.57,     UI.y + 1.26, 1.0,1.0,0.64 , "~w~" .. math.ceil(Speed), 255, 255, 255, 255)
                    drawTxt(UI.x + 0.588,     UI.y + 1.270, 1.0,1.0,0.4, "~w~ km/h", 255, 255, 255, 255)
                else
