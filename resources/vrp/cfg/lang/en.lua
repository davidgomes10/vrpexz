...
local lang = {
  common = {
    welcome = "Bem vindo. Use a seta para usar o menu de Interação de Jogador.~n~last login: {1}",
  ...
  cityhall = {
    ...
    menu = {
      title = "🆔 Identidade",
      info = "<em>Nome: </em>{1}<br /><em>Sobrenome: </em>{2}<br /><em>Idade: </em>{3}<br /><em>RG n°: </em>{4}<br /><em>Telefone: </em>{5}<br /><em>Endereço: </em>{7}, {6}<br /><em>Emprego: {8}</em>"
    }
  },
  police = {
    title = "👮 Policia",
    ...
    menu = {
      handcuff = {
		...
		algemado = "Você foi algemado.",
		desalgemado = "Você foi liberado."
      },
      putinveh = {
        title = "Colocar suspeito",
      ...
      fine = {
        ...
        notify_fined = "~b~Você foi multado em ~s~ {2} R$ por ~b~{1}.",
    ...
    identity = {
      info = "<em>Nome: </em>{1}<br /><em>Primeiro nome: </em>{2}<br /><em>Idade: </em>{3}<br /><em>RG n°: </em>{4}<br /><em>Telefone: </em>{5}<br /><em>Empresas: </em>{6}<br /><em>Capital comercial: </em>{7}$<br /><em>Endereço: </em>{9}, {8}<br /><em>Emprego: </em>"
    }
  },
  emergency = {
    menu = {
  ...
  phone = {
    ...
    hangup = {
      title = "Desligar",
      description = "Desligar a chamada."
    }
  },
  emotes = {
    title = "🙀 Animações",
  ...
  itemtr = {
    not_enough_reagents = "~r~Não possui reagentes.",
    informer = {
